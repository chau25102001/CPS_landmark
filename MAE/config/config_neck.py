...
def get_config(train=True):
    ...
    if not os.path.exists(C.log_dir):
        os.mkdir(C.log_dir)
    C.train_text = '/home/s/chaunm/CPS_landmarks/data/split_mae_neck/train.txt'
    C.test_text = "/home/s/chaunm/CPS_landmarks/data/split_mae_neck/test.txt"
    C.images_path = '/home/s/chaunm/DATA/AFLW/MAE_images_neck'
