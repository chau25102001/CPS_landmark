...
def get_config(train=True):
    ...
    if not os.path.exists(C.log_dir):
        os.mkdir(C.log_dir)
    C.train_text_labeled = '/home/s/chaunm/CPS_landmarks/data/split/train_labeled_1_1.txt'
    C.train_text_unlabeled = '/home/s/chaunm/CPS_landmarks/data/split/train_labeled_1_1.txt'
